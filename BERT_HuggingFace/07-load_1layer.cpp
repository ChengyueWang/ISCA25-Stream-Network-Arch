...
int main() {
    ...
    load_success = load_data("06-python_gold/4-attention.output.LayerNorm-bias.txt", data_bias, 1024); if (load_success == -1) return -1;
    ...
    layer_normalization (dense1, norm1, data_weight, data_bias, 512, 1024);
