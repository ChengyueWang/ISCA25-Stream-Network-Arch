...
void generate_instruction_query_key_value  ( uint32_t *inst_sequence, uint32_t & count4B,  uint32_t & countInstPkt, ParamsOneLayer params_query,  ParamsOneLayer params_key, ParamsOneLayer params_value){
    ...
    // a = 1; b = 0; generate_instruction_loadB(a, b, inst_sequence, count4B, countInstPkt, params_value);
    // loadA_a = 1; loadA_b = 0; storeC_a = 0; storeC_b = 0; 
    // generate_instruction_K8_steady_ddr(loadA_a, loadA_b, storeC_a, storeC_b, inst_sequence, count4B, countInstPkt, params_value);

    // a = 2; b = 0; generate_instruction_loadB(a, b, inst_sequence, count4B, countInstPkt, params_value);
    // loadA_a = 2; loadA_b = 0; storeC_a = 1; storeC_b = 0;
    // generate_instruction_K8_steady_ddr(loadA_a, loadA_b, storeC_a, storeC_b, inst_sequence, count4B, countInstPkt, params_value);

    // a = 3; b = 0; generate_instruction_loadB(a, b, inst_sequence, count4B, countInstPkt, params_value);
    // loadA_a = 3; loadA_b = 0; storeC_a = 2; storeC_b = 0;
    // generate_instruction_K8_steady_ddr(loadA_a, loadA_b, storeC_a, storeC_b, inst_sequence, count4B, countInstPkt, params_value);
...
void generate_instruction_onelayer_first2load_A1B4K8 ( uint32_t *inst_sequence, uint32_t & count4B,  uint32_t & countInstPkt, ParamsOneLayer params){
    uint32_t a_iter = params.a_iter;
    uint32_t b_iter = params.b_iter;
    uint32_t k_iter = params.k_iter;
