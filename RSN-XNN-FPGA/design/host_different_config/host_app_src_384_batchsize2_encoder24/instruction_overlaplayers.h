...
void generate_instruction_norm1_gelu_norm2  ( uint32_t *inst_sequence, uint32_t & count4B,  uint32_t & countInstPkt, ParamsOneLayer params_norm1,  ParamsOneLayer params_dense2, ParamsOneLayer params_norm2){
    ...
    a=0; b=0;
    generate_instruction_onelayer_cores_meshes_add_prev_layer(inst_sequence, count4B, countInstPkt, params_norm1);
    ...
    generate_instruction_onelayer_cores_meshes(inst_sequence, count4B, countInstPkt, params_dense2);
    a = 0; b = 0; generate_instruction_loadB(a, b, inst_sequence, count4B, countInstPkt, params_dense2);
    a = 0; b = 0; offset = 0; repeat_num = k_iter; 
    generate_instruction_loadA(a, b, offset, repeat_num, inst_sequence, count4B, countInstPkt, params_dense2);
    a = 0; b = 1; generate_instruction_loadB(a, b, inst_sequence, count4B, countInstPkt, params_dense2);
    loadA_a = 0; loadA_b = 1; storeC_a = 0; storeC_b = 0; 
    ...
    a = 0; b = 2; generate_instruction_loadB(a, b, inst_sequence, count4B, countInstPkt, params_dense2);
    loadA_a = 0; loadA_b = 2; storeC_a = 0; storeC_b = 1;
    generate_instruction_ddr_K8_steady_for_gelu(loadA_a, loadA_b, storeC_a, storeC_b, inst_sequence, count4B, countInstPkt, params_dense2);
    a = 0; b = 3; generate_instruction_loadB(a, b, inst_sequence, count4B, countInstPkt, params_dense2);
    loadA_a = 0; loadA_b = 3; storeC_a = 0; storeC_b = 2;
    generate_instruction_ddr_K8_steady_for_gelu(loadA_a, loadA_b, storeC_a, storeC_b, inst_sequence, count4B, countInstPkt, params_dense2);
    a = 0; b = 3; generate_instruction_storeC(a, b, inst_sequence, count4B, countInstPkt, params_dense2);
    ...
    a=0; b=0;
    generate_instruction_onelayer_cores_meshes_add_prev_layer(inst_sequence, count4B, countInstPkt, params_norm2);
