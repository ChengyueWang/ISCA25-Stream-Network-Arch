...
void reorderArray_4096(float* array) {
    ...
    for (int i = 0; i < numBlocks; ++i) {
        std::copy(array + newOrder[i] * blockSize, array + (newOrder[i] + 1) * blockSize, temp + i * blockSize);
    }
...
void replicate_matrix (float * matrix, int row, int col, int num_replicate){
    std::cout<< "replicate_matrix row = " << row << " col = " << col << " num_replicate = " << num_replicate << std::endl;
...
void convert_input_weight_gold_to_2AXI (
float * fmap0_embedding,
float * weight0_query,
...
void generate_data_onelayer_with_bias( float* host_inA_port, float* host_inB_port, float* bias, float* host_outC_port, float* gold_val, ParamsOneLayer params){
    ...
    std::string file_name = "/home/cw4/github/versal-float32/20-inputlen384/design/pl_src/output/0_onelayer_";
...
void generate_data_fusedlayer384 ( float* host_L1_inA, float* host_L1_inB, float* host_L2_inB, float* host_L2_outC, float* gold_val, ParamsFusedLayer params){
    
    std::cout<< "generate_data_fusedlayer384" << std::endl;
    params.print();

    int num_layer = params.num_layer;
    
    // init_matrix (host_L1_inA, 384, 64 * num_layer, 1.0);
    init_matrix (host_L1_inB, 384, 64 * num_layer, 1.0);
    init_matrix (host_L2_inB, 384, 64 * num_layer, 1.0);
    // init_matrix (host_L2_outC, 384, 64 * num_layer,  0);

    std::string file_name = "/home/cw4/github/versal-float32/20-inputlen384/design/pl_src/output/0_fuse_";


    init_matrix_blocked (host_L1_inA, 384, 64 * num_layer, 128, 64);
    // init_matrix_blocked (host_L1_inB, 384, 64 * num_layer, 128, 64);
    // init_matrix_blocked (host_L2_inB, 384, 64 * num_layer, 128, 64);

    // init_matrix_random(host_L1_inA, 384 * num_layer, 64);
    // init_matrix_random(host_L1_inB, 384 * num_layer, 64);
    // init_matrix_random(host_L2_inB, 384 * num_layer, 64);

    for (int l=0; l<num_layer; l++){

        float * curlayer_L1_outC = (float *)malloc(384 * 384 * sizeof(float));
        float * curlayer_softmax_out = (float *)malloc(384 * 384 * sizeof(float));
        float * curlayer_transposed = (float *)malloc(384 * 384 * sizeof(float));
        float * curlayer_L1_inA = (float *)malloc(64 * 384 * sizeof(float));
        float * curlayer_L1_inB = (float *)malloc(64 * 384 * sizeof(float));
        float * curlayer_L2_inB = (float *)malloc(64 * 384 * sizeof(float));
        float * curlayer_L2_outC = (float *)malloc(64 * 384 * sizeof(float));
        ...
        transpose_matrix(curlayer_L1_inB, curlayer_transposed, 384, 64);
        calculate_matrix(curlayer_L1_inA, curlayer_transposed, curlayer_L1_outC, 384, 384, 64);
        
        calculate_softmax(curlayer_L1_outC, curlayer_softmax_out, 384, 384);
        calculate_matrix(curlayer_softmax_out, curlayer_L2_inB, curlayer_L2_outC, 384, 64, 384);

        // calculate_matrix(curlayer_L1_outC, curlayer_L2_inB, curlayer_L2_outC, 384, 64, 384);
        ...
        print_matrix_to_file( file_name + "0_l" + to_string(l) + "_L1_outC.txt", curlayer_L1_outC, 384, 384);
        print_matrix_to_file( file_name + "0_l" + to_string(l) + "_softmax_out.txt", curlayer_softmax_out, 384, 384);
    ...
    print_matrix_to_file( file_name + "L1_inA_matrix.txt", host_L1_inA, 384, 64*num_layer);
    print_matrix_to_file( file_name + "L1_inB_matrix.txt", host_L1_inB, 384, 64*num_layer);
    print_matrix_to_file( file_name + "L2_inB_matrix.txt", host_L2_inB, 384, 64*num_layer);
    print_matrix_to_file( file_name + "gold_L2_outC.txt" , gold_val   , 384, 64*num_layer);

    convert_simple_to_blocked_layout(host_L1_inA, 384, 64*num_layer, 128, 64);
    convert_simple_to_blocked_layout(host_L1_inB, 384, 64*num_layer, 128, 64);
    convert_simple_to_blocked_layout(host_L2_inB, 384, 64*num_layer, 128, 64);
    convert_simple_to_blocked_layout(gold_val   , 384, 64*num_layer, 128, 64);

    print_matrix_to_file( file_name + "L1_inA_matrix_blocked.txt", host_L1_inA, 384, 64*num_layer);
    print_matrix_to_file( file_name + "L1_inB_matrix_blocked.txt", host_L1_inB, 384, 64*num_layer);
    print_matrix_to_file( file_name + "L2_inB_matrix_blocked.txt", host_L2_inB, 384, 64*num_layer);
    print_matrix_to_file( file_name + "gold_L2_outC_blocked.txt" , gold_val   , 384, 64*num_layer);

    convert_blocked_to_2AXI_layout(host_L1_inA, 384, 64*num_layer);
    convert_blocked_to_2AXI_layout(host_L1_inB, 384, 64*num_layer);
    convert_blocked_to_2AXI_layout(host_L2_inB, 384, 64*num_layer);
    convert_blocked_to_2AXI_layout(gold_val   , 384, 64*num_layer);

    print_matrix_to_file( file_name + "L1_inA_matrix_2AXI.txt", host_L1_inA, 384, 64*num_layer);
    print_matrix_to_file( file_name + "L1_inB_matrix_2AXI.txt", host_L1_inB, 384, 64*num_layer);
    print_matrix_to_file( file_name + "L2_inB_matrix_2AXI.txt", host_L2_inB, 384, 64*num_layer);
    print_matrix_to_file( file_name + "gold_L2_outC_2AXI.txt", gold_val, 384, 64*num_layer);
}
...
void cal_mulweight_add_prev_layer (float * pre_layer, float * weight_mul_pre_layer, float * gold_val, int A, int B){
