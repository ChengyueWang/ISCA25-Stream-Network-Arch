...
void generate_instruction_fusedlayer(uint32_t *inst_sequence, uint32_t &count4B,
                                     uint32_t &countInstPkt, ParamsFusedLayer &params) {
...
void generate_instruction_fusedlayer_numlayer1(uint32_t *inst_sequence, uint32_t &count4B,
                                               uint32_t &countInstPkt, ParamsFusedLayer &params) {
  union_inst_header inst_header;
  union_inst_ddr inst_ddr;
  union_inst_memcore_A inst_memcore_A;
