...
//  ========================================================================
// header is 32 bits
// data is varying length according to opcode, and the number of data depends on
// LEN_MOP_BUFFER_WINDOW_SIZE
...
void printHeaderInst(INST_HEADER_TYPE inst_val, uint32_t countInstPkt) {
  ...
  std::cout << "mask: " << inst_val.mask << " is_last_mOP: " << inst_val.is_last_mOP
            << " mop_buffer_window_size: " << inst_val.mop_buffer_window_size
            << " repeat_num: " << inst_val.repeat_num << std::endl;
}

void generate_last_inst_for_all_modules(uint32_t *inst_sequence, uint32_t &count4B,
