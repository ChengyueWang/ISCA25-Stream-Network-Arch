...
void generate_instruction_Klarger16_steady_ddr_colapsetwolayer_storeCloadA(
...
void generate_instruction_onelayer_coreAB_meshes_add_prev_layer_epilog(uint32_t *inst_sequence,
                                                                       uint32_t &count4B,
...
void generate_instruction_onelayer_coreAB_meshes_add_prev_layer_prolog(uint32_t *inst_sequence,
                                                                       uint32_t &count4B,
                                                                       uint32_t &countInstPkt,
                                                                       ParamsOneLayer params) {
  uint32_t a_iter = 1;
...
void generate_instruction_norm1_gelu_norm2(uint32_t *inst_sequence, uint32_t &count4B,
                                           uint32_t &countInstPkt, ParamsOneLayer params_norm1,
  ...
  a = 3;
  b = 0;
  generate_instruction_onelayer_coreAB_meshes_add_prev_layer_epilog(inst_sequence, count4B,
                                                                    countInstPkt, params_norm1);
  ...
  storeC_a = 3;
  storeC_b = 3;
  generate_instruction_Klarger16_steady_ddr_colapsetwolayer_storeCloadA(
      loadA_a, loadA_b, storeC_a, storeC_b, inst_sequence, count4B, countInstPkt, params_dense2,
      params_norm2);
  ...
  generate_instruction_Klarger16_steady_ddr(loadA_a, loadA_b, storeC_a, storeC_b, inst_sequence,
                                            count4B, countInstPkt, params_norm2);
